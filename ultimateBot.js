        ...
        async getFullArchive() {
            try {
                ...
                if (fs.existsSync(filePath)) {
                    ...
                    return lines; // מחזיר את כל השורות לניתוח מעמיק
                }
                return [];
            } catch (e) {
                return [];
